                ...
                <div class="card mt-3">
                    <div class="card-body">
                        <h4 class="card-title">顧客訊息</h4>
                            <p>地址：<small id="addr1"></smaill></p>
                            <p>Emial：<small id="email1"></smaill></p>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            url: '/rest/api/manger/detail',
            dataType: "json",
            type: 'get',
            data: {orderlist:id,shop_id:shop,user_id:user},
            success: function (data) {
                if(data.success==1){
                    ...
                    var d=data.user
                    document.getElementById('email1').innerHTML=d[0].email;
                    // console.log(d[0].addr)
                    document.getElementById('addr1').innerHTML=d[0].addr;
                }
            }
        });
    });
